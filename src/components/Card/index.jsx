...
const CardLink = ({ data }) => {
  console.log(data);
  const { media, name, location, description, rating, meta } = data;
      ...
      <CardBody>
        ...
        <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
          ...
          <Tooltip content="Pets Allowed">
            <span className="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">
              <IoPaw className="h-5 w-5" /> {/* Use the dog icon */}
            </span>
          </Tooltip>
          ...
          <Tooltip content="And +20 more">
            <span className="cursor-pointer rounded-full border border-gray-900/5 bg-gray-900/5 p-3 text-gray-900 transition-colors hover:border-gray-900/10 hover:bg-gray-900/10 hover:!opacity-100 group-hover:opacity-70">+20</span>
          </Tooltip>
        </div>
      </CardBody>
